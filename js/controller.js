(function (window) {
    ...
    function Controller(model, view) {
        ...
        that.view.bind ('markItemCompleted', function (item) {
            that.markItemAsCompleted (item.id, item.isCompleted);
        });
    ...
    Controller.prototype.markItemAsCompleted = function (id, isCompleted) {
        var that = this;
